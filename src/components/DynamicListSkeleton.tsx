...
const DynamicListSkeleton: React.FC<DynamicListHomeProps> = ({
  category,
  data = [{ id: 1, category }, { id: 2, category }, { id: 2, category }],
    ...
    return (
      ...
      >
        ...
        >
          ...
          >   
              <Skeleton colorMode={colorMode} radius={8} height={35} width={35} />
              <View style={{ height: 16 }} />

              <View style={{ paddingHorizontal: 10 }}>
                  <Skeleton colorMode={colorMode} width={250} height={12} />
                  <View style={{ height: 16 }} />
